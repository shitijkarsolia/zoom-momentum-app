...
todos:
  - id: rtms-access
    ...
    status: pending
  - id: zoom-app-setup
    content: Create Zoom App on Marketplace, configure OAuth, scopes, SDK capabilities, RTMS events, and deploy to EC2
    status: pending
...
- Domain allow list: `zoom.shitijmathur.tech` + `appssdk.zoom.us`
