...
The app is registered at [marketplace.zoom.us](https://marketplace.zoom.us) and deployed to EC2 at `zoom.shitijmathur.tech`.

### OAuth Settings
- **Redirect URL:** `https://zoom.shitijmathur.tech/api/auth/callback`
- **Allow List:** `zoom.shitijmathur.tech`, `appssdk.zoom.us`
...
- **App doesn't load in Zoom:** Verify the Home URL in Marketplace matches `zoom.shitijmathur.tech`. Check browser console for SDK errors.
